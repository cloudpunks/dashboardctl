...
what has changed between each version. When you implement a new feature, do NOT
update the changelog manually as this will be updated by the automated release
process.
...
info@cloudpunks.de. If it's not a big deal, a pull request will probably be
faster.
...
[issues]: https://github.com/cloudpunks/dashboardctl/issues
